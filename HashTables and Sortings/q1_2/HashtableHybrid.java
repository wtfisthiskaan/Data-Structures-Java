...
public class HashtableHybrid<K, V> implements KWHashMap<K, V> {
		...
		*/
		...
		/** Constructor of HashtableHybrid
		* @param capacity capacity of table.
		*/
		public HashtableHybrid(int capacity) {
		...
		/** isPrime function
		* @param n is checked number whether it is prime.
		...
		*/
        ...
        return true;
    	}/** findPrimeNum function
		* @return prime number for p<=0.8*table_size.
		*/
		...
		/** Method get for class HashtableHybrid.
		...
		*/
		...
		/** Method put for class HashtableHybrid.
		...
		*/
		...
		/** Remove method for Hybrid table.
